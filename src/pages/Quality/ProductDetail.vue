<template>
  <div class="ProductDetail">
    <div class="top">
      ...
      <!-- <img src="../../assets/images/collect.png" class="top-collect"> -->
    ...
    <div class="buy">
      <div class="buy-box flex-h">
        <div class="contact flex-h">
          ...
          <img src="../../assets/images/shop-car.png" alt class="contact-img shop-car">
          <div class="contact-txt" @click.stop="$router.push({name: 'ShopCar', params: {}})">购物车</div>
        </div>
