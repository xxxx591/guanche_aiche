<template>
  <div class="Main">
    ...
    <div class="car-box flex-h">
      <div class="car-item" @click.stop="gotoPage({name: 'ChooseCar', pageUrl: '/Car/ChooseCar'})">
        <div class="car-img">
          <img src="../../assets/images/index-icon1.png" class="car-img2">
        </div>
      ...
      <div class="car-item">
        ...
        <div class="car-img">
          <img src="../../assets/images/index-icon2.png" class="car-img2">
        </div>
        <div class="car-txt">牵引车</div>
      </div>
      <div class="car-item" @click.stop="gotoQualityMainPage">
        <div class="car-img">
          <img src="../../assets/images/index-icon3.png" class="car-img2">
        </div>
      ...
      >
        <div class="car-img">
          <img src="../../assets/images/index-icon4.png" class="car-img2">
        </div>
      ...
      >
        <div class="car-img">
          <img src="../../assets/images/index-icon5.png" class="car-img2">
        </div>
      ...
      <div class="car-item" @click.stop="gotoPage({name: 'QuanMain', pageUrl: '/Index/QuanMain'})">
        <div class="car-img">
          <img src="../../assets/images/index-icon6.png" class="car-img2">
        </div>
    ...
    <div class="shop" @click.stop="gotoPage({name: 'PointsMall', pageUrl: '/Index/PointsMall'})">
      <img src="../../assets/images/shop.png" class="shop-img">
    </div>
    <div class="service-box flex-h">
      <div class="service flex-h">
        ...
        <div class="service-img service-img-house">
          <img src="../../assets/images/search.png" alt class="service-img2">
        </div>
      </div>
      <div class="service flex-h">
        <div class="service-txt">车险服务</div>
        <div class="service-img service-img-carservice">
          <img src="../../assets/images/house.png" alt class="service-img2">
        </div>
      </div>
      <div class="service flex-h">
        <div class="service-txt">油卡查询</div>
        <div class="service-img">
          <img src="../../assets/images/card.png" alt class="service-img2">
        </div>
      </div>
      <div class="service flex-h">
        <div class="service-txt">线上服务</div>
        <div class="service-img service-img-persion">
          <img src="../../assets/images/person.png" alt class="service-img2">
        </div>
      </div>
    </div>
