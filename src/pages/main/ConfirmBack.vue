<template>
  <div class="ConfirmBack">
    ...
    <div class="c-success flex-v">
      <img src="../../assets/images/confirmOk.png" alt class="c-img">
      <div class="txt">支付成功</div>
      <div class="info flex-h">
        <div class="info1">支付金额：</div>
        <div class="info2">199积分</div>；
        <div class="info1">支付方式：</div>
        <div class="info2">积分</div>
      </div>
      <div class="btn flex-h">
        <div class="back flex-h flex-cc" @click.stop="gotoHome">回首页</div>
        <div class="detail flex-h flex-cc" @click.stop="$router.push({name: 'OrderList'})">查看订单</div>
      </div>
    </div>
    <div class="warning">
      温馨提示：
